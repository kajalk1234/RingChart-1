...
```bash
npm install maq-visuals-legend-chartutils@3.0.0 --save
```
...
* ```node_modules/maq-visuals-legend-chartutils/lib/index.d.ts```
...
* ```node_modules/maq-visuals-legend-chartutils/lib/index.js```
...
* ```node_modules/maq-visuals-legend-chartutils/lib/index.css```

As a result you will have the following file structure:
```less
@import (less) "node_modules/powerbi-visuals-utils-interactivityutils/lib/index.css";
@import (less) "node_modules/maq-visuals-legend-chartutils/lib/index.css";
```
